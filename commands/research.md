...
4. **Wait for all sub-agents to complete and synthesize findings:**
   ...
   - Verify all context/ paths are correct (e.g., context/shekh/ not context/ for personal files)
...
6. **Generate research document:**
   ...
   - Structure the document with YAML frontmatter followed by content:
     ...
     **Repository**: [Repository name]
     ...
     - `context/plans/something.md` - Historical decision about X
     - `context/local/notes.md` - Past exploration of Y
       Note: Paths exclude "searchable/" even if found there

     ## Related Research

     [Links to other research documents in context/research/]
...
- Explore all of context/ directory, not just research subdirectory
